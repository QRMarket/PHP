<!-- - - - - - - - - - - - - - Footer - - - - - - - - - - - - - - - - -->
                                    ...
                                    <div class="container">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-sm-6">
                                                            ...
                                                            <img src="<?php echo ROOT_PATH; ?>images/logo.png" alt="" class="footer_logo">
                                                            ...
                                                            <p>Email: <a href="mailto:#" class="mail_to">info@companyname.com</a></p>
                                                    ...
                                                    <div class="col-md-3 col-sm-6">
                                                            ...
                                                            <section class="widget">
                                                                    ...
                                                                    <ul class="list_of_links">
                                                                            ...
                                                                            <li><a href="#">Medicine &amp; Health (1375)</a></li>
                                                                            <li><a href="#">Beauty (1687)</a></li>
                                                                            <li><a href="#">Personal Care (1036)</a></li>
                                                                            <li><a href="#">Vitamins &amp; Supplements (202)</a></li>
                            ...
                            <div class="footer_section_3 align_center">
                                    ...
                                    <div class="container">
                                            ...
                                            <ul class="payments">
                                                    ...
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_1.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_2.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_3.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_4.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_5.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_6.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_7.png" alt=""></li>
                                                    <li><img src="<?php echo ROOT_PATH; ?>images/payment_8.png" alt=""></li>
            ...
            ============================================ -->
            <script src="<?php echo ROOT_PATH; ?>js/jquery-2.1.1.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/queryloader2.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/jquery.appear.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/owlcarousel/owl.carousel.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/royalslider/jquery.easing-1.3.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/jquery.countdown.plugin.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/jquery.countdown.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/arcticmodal/jquery.arcticmodal.js"></script>
            <script src="twitter/jquery.tweet.min.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/colorpicker/colorpicker.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/retina.min.js"></script>
            <script type="text/javascript" src="http://s7.addthis.com/../js/300/addthis_widget.js"></script>

            <!-- Theme files
            ============================================ -->
            <script src="<?php echo ROOT_PATH; ?>js/theme.plugins.js"></script>
            <script src="<?php echo ROOT_PATH; ?>js/theme.core.js"></script>
